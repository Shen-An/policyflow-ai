...
| F1 | 登录、会话、AppShell、路由守卫 | 已完成 | 已满足 |
| F2 | 用户列表、创建用户、修改角色 | 已完成 | 已满足 |
| F3 | 知识库、文档上传、索引状态 | 已完成 | 已满足 |
| F4 | 问答、引用、反馈、草稿 | 已完成 | 已满足 |
| F5 | FAQ、审计、评估 | 已完成 | 已满足 |
| F6 | Skill、Tool、MCP | 已完成 | 已满足 |
| F7 | 可访问性、性能、部署、全量 E2E | 已完成 | 已满足 |
