    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 max-h-[90vh] w-[calc(100%-32px)] max-w-xl -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-[var(--space-6)] shadow-xl focus:outline-none">
          ...
          <Dialog.Close className="absolute right-[var(--space-4)] top-[var(--space-4)] inline-flex size-9 items-center justify-center rounded-md text-[var(--color-text-secondary)] hover:bg-slate-100" aria-label="关闭对话框"><X size={16} weight="regular" className="size-5" aria-hidden="true" /></Dialog.Close>
